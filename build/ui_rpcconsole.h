...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->resize(726, 559);
        horizontalLayout_2 = new QHBoxLayout(RPCConsole);
        ...
        numberOfPow = new QLabel(tab_info);
        numberOfPow->setObjectName(QString::fromUtf8("numberOfPow"));
        numberOfPow->setCursor(QCursor(Qt::IBeamCursor));
        numberOfPow->setTextFormat(Qt::PlainText);
        numberOfPow->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(numberOfPow, 11, 1, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "CFCOIN - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the CFCOIN debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        openDebugLogfileButton->setText(QApplication::translate("RPCConsole", "&Open", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the CFCOIN-Qt help message to get a list with possible CFCOIN command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        showCLOptionsButton->setText(QApplication::translate("RPCConsole", "&Show", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "CFCOIN Core", 0, QApplication::UnicodeUTF8));
        ...
        label_15->setText(QApplication::translate("RPCConsole", "Current pow height", 0, QApplication::UnicodeUTF8));
        numberOfPow->setText(QApplication::translate("RPCConsole", "N/A", 0, QApplication::UnicodeUTF8));
